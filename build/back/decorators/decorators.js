...
const controllerHandler_1 = require("../handlers/controllerHandler");
const methodHandler_1 = require("../handlers/methodHandler");
const http_1 = require("../_http/http");
const injection_js_1 = require("injection-js");
require("reflect-metadata");
const getFunctionParametersNames = require("get-parameter-names");
/**
...
function Controller(target) {
    ...
    let controllerHandler = container_1.Container.controllerHandlers[controllerName];
...
function RequestBody(target, methodName, parameterIndex) {
    ...
    let paramName = getFunctionParametersNames(target[methodName])[parameterIndex];
